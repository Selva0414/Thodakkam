...
import {
  ...
  SafeAreaView, Platform, TextInput, Image, KeyboardAvoidingView
} from 'react-native';
import {
  Menu, Search, Plus, Smile, Send, Briefcase, Users, Calendar, LayoutGrid
...
export default function StartupMessages() {
  ...
  const candidates = [
    { id: '1', name: 'Shabari', active: true, avatar: 'https://i.pravatar.cc/150?u=Shabari' },
    { id: '2', name: 'Jamie Smith', active: false, avatar: 'https://i.pravatar.cc/150?u=Jamie' },
    { id: '3', name: 'Taylor Ott', active: false, avatar: 'https://i.pravatar.cc/150?u=Taylor' },
    { id: '4', name: 'Jordan Lee', active: false, avatar: 'https://i.pravatar.cc/150?u=Jordan' }
  ];
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
        ...
        <View style={styles.candidateListContainer}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.candidateList}>
            {candidates.map(candidate => (
              <TouchableOpacity key={candidate.id} style={styles.candidateItem}>
        ...
        <ScrollView style={styles.chatArea} contentContainerStyle={styles.chatContent}>
          ...
          <View style={styles.messageRow}>
            <Image source={{ uri: candidates[0].avatar }} style={styles.messageAvatar} />
            <View style={styles.messageContent}>
              <Text style={styles.messageMeta}>Shabari • 10:24 AM</Text>
              <View style={styles.messageBubbleReceived}>
                <Text style={styles.messageTextReceived}>Hey, did you get a chance to look at the lab visualization?</Text>
              </View>
            </View>
          </View>
            ...
            <View style={[styles.messageContent, { alignItems: 'flex-end' }]}>
              ...
              <View style={styles.attachmentCard}>
                <View style={styles.attachmentPreview}>
                  <Image source={{ uri: 'https://via.placeholder.com/300x150.png?text=Visualization' }} style={styles.attachmentImg} />
                </View>
                <View style={styles.attachmentFooter}>
                  <View>
                    <Text style={styles.attachmentName}>lab_visualization_v1.png</Text>
          ...
          <View style={styles.messageRow}>
            <Image source={{ uri: candidates[0].avatar }} style={styles.messageAvatar} />
            <View style={styles.messageContent}>
              <Text style={styles.messageMeta}>Shabari • 10:32 AM</Text>
              <View style={styles.messageBubbleReceived}>
                <Text style={styles.messageTextReceived}>This looks amazing! The data flow is much clearer now.</Text>
              </View>
            </View>
          </View>
        </ScrollView>
