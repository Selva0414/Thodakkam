        ...
        <View style={styles.commentsSection}>
          {comments.map((c: any) => {
            ...
            <View key={c.id} style={styles.commentItem}>
              {avatar ? (
                <Image source={{ uri: avatar }} style={[styles.commentAvatar, { backgroundColor: '#ffffff' }]} />
              ) : (
          ...
          <View style={styles.commentInputRow}>
            {companyLogo ? (
              <Image source={{ uri: companyLogo }} style={[styles.commentAvatar, { backgroundColor: '#ffffff' }]} />
            ) : (
              <View style={[styles.commentAvatar, { backgroundColor: colors.primary, justifyContent: 'center', alignItems: 'center' }]}>
